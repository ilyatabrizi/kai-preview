/* KAI preview — offline shell */
const C = 'kai-583acdbf2e';
const CORE = ['./','./index.html','./app.css?v=583acdbf2e','./app.js?v=583acdbf2e','./data.js?v=583acdbf2e','./manifest.webmanifest'];
